...
# 2016-2-12 v0.1
# Chapter 7 : Newton's Method for Calculating "Better" Square Roots 
...
#            ("Zuki", ["Sociology", "Economics", "CommLaw", "Stats", "Music"])]
...
def sqrt(n):
    approx = n/2.0          # Start with some or other gues at the answer
    while True:
